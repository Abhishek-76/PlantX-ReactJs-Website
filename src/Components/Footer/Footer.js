            ...
            <Fade top  cascade duration={2500}>
                <div className="footer__content">
                    ...
                    <div className="footer__subscribe">
                        <input type="email" placeholder="Enter your E-mail" className="footer__input"/>
                        <button className="button button--flex footer__button">
                            Subscribe
                            <RiArrowRightUpLine className="button__icon"/>                        </button>
                    </div>
                </div>
            ...
            <div className="footer__content">
                ...
                <ul className="footer__data">
                    ...
                    <div className="footer__social">
                        ...
                        <a href="https://www.twiter.com/" className="footer__social-link">
                            <IoLogoTwitter/>
                        </a>
                    </div>
                </ul>
